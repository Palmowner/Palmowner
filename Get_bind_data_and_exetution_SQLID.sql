begin
    execute immediate('SELECT /*+ INDEX(SCHEMA.IND23) */ YUODAY FROM SCHEMA.TABLE WHERE ID=:B5 AND MINOR=:B4 AND MAJOR=:B3 AND SDAY>=:B2 AND SDAY< :B1 +1 AND STATE<>105 ORDER BY SDAY DESC') using 16,7346,18612267,TO_DATE('10/03/2023 00:00:00','MM/DD/YYYY HH24:MI:SS'),TO_DATE('10/03/2023 00:00:00','MM/DD/YYYY HH24:MI:SS');
end;
